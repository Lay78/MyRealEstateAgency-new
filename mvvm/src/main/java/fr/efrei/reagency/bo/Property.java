    ...
    implements Serializable
{
    ...
    public Property(@NonNull String propertyType,
                    ...
                    @NonNull String propertyDateUpdate, @NonNull String propertyStatus,
                    @NonNull String propertyAgentName, @NonNull byte[] imageBlob)
    {
        ...
        this.propertyDateCreation = propertyDateCreation + " 00:00:00.000";
        this.propertyDateUpdate = propertyDateUpdate + " 00:00:00.000";
    ...
    //They are used in order to compare properties (sort + deletion)
    @Override
